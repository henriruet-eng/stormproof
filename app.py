...
st.metric("Average drawdown reduction", "-48 %")
st.success("Live demo available on request — NDA required for engine details")
st.info("Contact: henri@stormproof.capital | +33 6 63 54 70 00")
